...
import workText from './public/work.txt'
const md = Markdown.markdown.toHTML
let preStyles = require('raw-loader!./css/prestyles.css')
let style0 = require('raw-loader!./css/styles0.css')
let style1 = require('raw-loader!./css/styles1.css')
let style2 = require('raw-loader!./css/styles2.css')
let style3 = require('raw-loader!./css/styles3.css')
require("babel-polyfill");
let speed =16;
let endOfSentence = /[\.\?\!]\s$/; // 以 .或?或！加一个空格结尾
let comma = /\D[\,]\s$/; // 任意非数字打头，跟一个 , 再加一个任意空白字符
let endOfBlock = /[\/]\n\n$/; // 以‘/’打头后面跟两个回车结尾
let style, styleEl, workEl
// 当文档元素加载完成后开始执行代码.
